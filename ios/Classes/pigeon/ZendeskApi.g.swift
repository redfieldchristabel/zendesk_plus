...
func deepEqualsZendeskApi(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case let (cleanLhsArray, cleanRhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in cleanLhsArray.enumerated() {
      if !deepEqualsZendeskApi(element, cleanRhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (cleanLhsDictionary, cleanRhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (key, cleanLhsValue) in cleanLhsDictionary {
      ...
      if !deepEqualsZendeskApi(cleanLhsValue, cleanRhsDictionary[key]!) {
        return false
      }
    }
    return true
...
func deepHashZendeskApi(value: Any?, hasher: inout Hasher) {
  if let valueList = value as? [AnyHashable] {
     for item in valueList { deepHashZendeskApi(value: item, hasher: &hasher) }
     return
  }
  ...
  if let valueDict = value as? [AnyHashable: AnyHashable] {
    for key in valueDict.keys { 
      hasher.combine(key)
      deepHashZendeskApi(value: valueDict[key]!, hasher: &hasher)
    }
    return
  }
...
struct ZendeskUser: Hashable {
  ...
  static func == (lhs: ZendeskUser, rhs: ZendeskUser) -> Bool {
    return deepEqualsZendeskApi(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashZendeskApi(value: toList(), hasher: &hasher)
  }
}
...
struct UserColors: Hashable {
  ...
  static func == (lhs: UserColors, rhs: UserColors) -> Bool {
    return deepEqualsZendeskApi(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashZendeskApi(value: toList(), hasher: &hasher)
  }
